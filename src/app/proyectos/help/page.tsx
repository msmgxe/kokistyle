  ...
  return [
    ...
    },
    {
      ...
      steps: EN ? [
        ...
        { t:"Download the PDF", d:"Click <b>Download PDF</b>. A professionally designed Luxaris Design proposal downloads instantly — centered header, full project name bar, 2-column item layout per section. The bottom section shows <b>Payment Schedule on the left</b> and <b>Discount + Grand Total on the right</b>, anchored to the same baseline." },
        ...
        { t:"Descargar PDF", d:"Clic en <b>Descargar PDF</b>. La propuesta Luxaris Design se descarga al instante — cabecera centrada, barra con el nombre completo del proyecto, items en 2 columnas por sección. La sección inferior muestra el <b>Calendario de Pagos a la izquierda</b> y el <b>Descuento + Gran Total a la derecha</b>, anclados a la misma línea base." },
