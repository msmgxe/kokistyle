  ...
  return [
    {
      ...
      steps: EN ? [
        { t:"Create a project", d:"Click <b>+ New Project</b> at the top. Fill in title, client name, address, budget and start date." },
        ...
        { t:"Filter by status", d:"Use the status chips (All · In Progress · Approved · Done) at the top of the project list." },
        { t:"Edit a project", d:"Click the <b>✏ pencil icon</b> on any project card to update its title, client, budget or status." },
      ] : [
        { t:"Crear un proyecto", d:"Clic en <b>+ Nuevo Proyecto</b>. Completa título, cliente, dirección, presupuesto y fecha de inicio." },
        ...
        { t:"Filtrar por estado", d:"Usa los chips de estado (Todos · En Obra · Aprobado · Terminado) en la parte superior de la lista." },
        { t:"Editar un proyecto", d:"Clic en el <b>ícono ✏ lápiz</b> de cualquier tarjeta para actualizar título, cliente, presupuesto o estado." },
      ],
      tips: EN ? [
