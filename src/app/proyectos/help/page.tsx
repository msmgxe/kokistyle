  ...
  return [
    ...
    },
    {
      ...
      steps: EN ? [
        ...
        { t:"Ask her things too — 8 kinds of question", d:"<b>Agenda:</b> \"What do I have today / tomorrow / this week?\" · <b>Project sheet:</b> \"How's Brickell going?\", \"Whose project is this?\" · <b>Notes:</b> \"Read me the notes for Miami Kitchen\" · <b>Money:</b> \"How much have I collected?\", \"How much is still owed?\", \"What did I spend it on?\" · <b>Tasks:</b> \"What's on for today?\" (all projects) or \"What's left in Brickell?\" · <b>Materials:</b> \"What's left to buy?\" · <b>Contacts:</b> \"What's Jorge's phone?\", \"Who are my plumbers?\" · <b>Gaps:</b> \"What am I missing on Brickell?\"" },
        { t:"What she answers depends on your role", d:"Each lookup is permission-gated: a <b>co-worker never hears amounts</b>, only what their permissions allow. The agenda and the \"what am I missing\" audit are <b>superadmin only</b>. If she can't answer something, she tells you which tab to open instead of guessing." },
      ] : [
        ...
        { t:"También puedes preguntarle — 8 tipos de pregunta", d:"<b>Agenda:</b> \"¿Qué tengo hoy / mañana / esta semana?\" · <b>Ficha del proyecto:</b> \"¿Cómo va Brickell?\", \"¿De quién es Cocina Miami?\" · <b>Notas:</b> \"Léeme las notas de Cocina Miami\" · <b>Dinero:</b> \"¿Cuánto llevo cobrado?\", \"¿Cuánto falta por cobrar?\", \"¿En qué se fue el dinero?\" · <b>Tareas:</b> \"¿Qué hay para hoy?\" (todos los proyectos) o \"¿Qué falta en Brickell?\" · <b>Materiales:</b> \"¿Qué falta comprar?\" · <b>Contactos:</b> \"¿Cuál es el teléfono de Jorge?\", \"¿Qué plomeros tengo?\" · <b>Huecos:</b> \"¿Qué me falta en Brickell?\"" },
        { t:"Lo que responde depende de tu rol", d:"Cada consulta está gateada por permisos: un <b>co-worker nunca escucha montos</b>, solo lo que sus permisos permiten. La agenda y la auditoría de \"¿qué me falta?\" son <b>solo superadmin</b>. Si no puede responder algo, te dice qué tab abrir en vez de adivinar." },
      ],
      tips: EN ? [
        ...
        "🔍 <b>\"What am I missing on Brickell?\"</b> audits the project: no estimate, no tasks, nobody assigned, no end date, approved but no income, tasks with no day, materials not bought, still to collect.",
        ...
        "🔍 <b>\"¿Qué me falta en Brickell?\"</b> audita el proyecto: sin estimado, sin tareas, sin equipo asignado, sin fecha de fin, aprobado pero sin ingresos, tareas sin día, materiales sin comprar, y cuánto falta por cobrar.",
