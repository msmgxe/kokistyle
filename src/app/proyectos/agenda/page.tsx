        ...
        <div key={ev.id} className="space-y-3 rounded-2xl border-2 border-[var(--accent)] bg-white dark:bg-[#111a2e] p-4">
          ...
          <div className="flex justify-end gap-2">
            ...
            <button onClick={saveEdit} disabled={saving || !editForm.title.trim()}
              className="inline-flex items-center gap-1 rounded-xl bg-[var(--brand)] px-4 py-2 text-sm font-bold text-white hover:bg-[var(--brand-strong)] disabled:opacity-50">
      ...
      <div key={ev.id}
        ...
        <div className="min-w-0 flex-1">
          ...
          <div className="mt-2 flex flex-wrap gap-1.5">
            {proj && (
              <span className="inline-flex items-center gap-1.5 rounded-full bg-[var(--accent)] py-0.5 pl-1 pr-2.5 text-[10px] font-bold text-white">
      ...
      <div className="mb-5 flex flex-wrap items-center justify-between gap-3">
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <button onClick={() => setShowForm(s => !s)}
            className="inline-flex items-center gap-1.5 rounded-xl bg-[var(--brand)] px-4 py-2.5 text-sm font-bold text-white hover:bg-[var(--brand-strong)]">
        ...
        <div className="mb-5 space-y-3 rounded-2xl border border-[#E6DDCB] dark:border-[#22304d] bg-white dark:bg-[#111a2e] p-4">
          ...
          <div className="flex justify-end gap-2">
            ...
            <button onClick={() => saveEntry(form, false)} disabled={saving}
              className="rounded-xl bg-[var(--brand)] px-4 py-2 text-sm font-bold text-white hover:bg-[var(--brand-strong)] disabled:opacity-50">
              {ta.save}
            </button>
          </div>
        </div>
